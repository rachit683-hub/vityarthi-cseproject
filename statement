...
Scope of the Project:-  The scope of the Modular Expense Analyzer is defined as follows:
Inclusions:
...
Exclusions (Out of Scope):  1. Integration with bank accounts or other external APIs.  
                            2. Advanced features like budgeting, forecasting, or setting spending limits.
                            3. Graphical User Interface (GUI); the project is strictly a Command-Line Interface (CLI) application.
                            4. Multi-user support or complex authentication.

Target Users:- The primary target users for the Modular Expense Analyzer are individuals who need a basic, reliable tool for personal financial tracking:
               1. Individuals: Anyone looking to gain better control and understanding of their personal monthly cash flow.
               2. Students/Beginners: Users who are new to tracking finances and require a simple, free, and straightforward command-line utility rather than complex, full-featured software.
               3.Developers/Data Enthusiasts: Users who prefer to keep their data local in a simple format (CSV) and appreciate the use of Pandas and Matplotlib for direct data analysis.
High-Level Features:- 
